<template>
  <div class="shelf-search-wrapper" :class="{'search-top': ifInputClicked}">
    ...
    <transition name="fade-and-slide-up">
      <div class="shelf-search-tab-wrapper" :class="{'hide-shadow': ifHideShadow}" v-show="ifInputClicked">
        <div
...
.shelf-search-wrapper {
  ...
  .shelf-search {
    ...
    .search-wrapper {
      flex: 1;
      display: flex;
      margin: px2rem(8) px2rem(8) px2rem(10);
